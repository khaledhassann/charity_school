...
public abstract class ILoginStrategy {
    ...
    protected static boolean validate(String username, String password, String filePath) {
        ...
        CredentialManager credentialManager = CredentialManager.getInstance(filePath);
    
        // Use the Singleton to validate the credentials
        return credentialManager.validate(username, password);
    }

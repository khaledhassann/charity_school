...
import com.rungroup.web.models.Active;
import com.rungroup.web.models.Assessment;
import com.rungroup.web.models.Course;
import com.rungroup.web.models.Draft;
import com.rungroup.web.models.State;
import com.rungroup.web.repositories.Implementations.AssessmentRepository;
...
public class AssessmentController {
    ...
    public static AssessmentRepository assessmentRepository = new AssessmentRepository();
    public static List<Assessment> all_assessments = assessmentRepository.findAll();
    private static List<Assessment> assessments = new ArrayList<>();

    // public AssessmentController(Course course){
    //     for(Assessment x: all_assessments){
    //         if(x.getCourse_id() == course.getId()){
    //             assessments.add(x);
    //         }
    //     }
    // }
